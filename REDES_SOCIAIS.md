...
## 2. Pilares de Conteúdo — Detalhamento e Proporção
...
## 3. Calendário Semanal (modelo recorrente)
...
> Frequência mínima viável (1 pessoa): 3 posts de feed/semana + Stories diários + 2 Reels/semana + 2-3
> TikToks/semana. Ajustar para cima conforme equipe crescer (ver `ESTRUTURA_EMPRESARIAL.md`).
...
## 6. Métricas para acompanhar (semanal)

| Métrica | Onde olhar | Meta inicial (mês 1-2) |
|---|---|---|
