...
- **Workflow separado**: pedidos de Ateliê entram por formulário próprio no site (ou link direto no WhatsApp VIP),
  com prazo de produção comunicado claramente (evita expectativa de "entrega rápida" como nos produtos de
  catálogo).
- **Capacidade inicial**: começar limitando a **5-10 pedidos personalizados/semana** nos primeiros 2 meses, para
  não comprometer a produção/expedição da linha de catálogo.
- **Insumos**: hot stamping e gravação podem ser terceirizados com a própria gráfica/fornecedor de cadernos
...
- Personalização (hot stamping, gravação): custo incremental baixo (~R$ 3-8/unidade), preço adicional de
  R$15-40 → **margem incremental de 70-85%** — a personalização é, proporcionalmente, o item de maior margem
  do catálogo.
- Convites e B2B: margem similar à linha de catálogo (45-55%), mas com **ticket muito maior por pedido** (pedido
  mínimo de 30 unidades = R$240+ por pedido).

---

## 5. Marketing da linha Ateliê

- **Conteúdo dedicado**: vídeos do processo de personalização (hot stamping ao vivo, embalagem do kit) — alto
...
## 6. Impacto nas projeções financeiras

A linha Ateliê **não substitui** a receita de catálogo — é um adicional que cresce com o reconhecimento de marca.
Estimativa conservadora para incorporar ao `PLANO_DE_NEGOCIO_V2.md` (cenário conservador, seção 8.1):

| Mês | Receita catálogo (R$) | Receita Ateliê (R$, adicional) | Receita total (R$) |
|---|---|---|---|
| 1-2 | 6.000 – 9.000 | 0 – 300 (testes/validação) | 6.000 – 9.300 |
| 3-4 | 13.000 – 18.000 | 500 – 1.200 | 13.500 – 19.200 |
| 5-6 | 24.000 – 32.000 | 1.500 – 3.000 (já incluindo algum pedido B2B/convites) | 25.500 – 35.000 |

- A receita de Ateliê tende a ter **picos sazonais fortes** (datas comemorativas, temporada de casamentos) —
  não tratar como linha constante, e sim como "bônus" que pode acelerar o ponto de equilíbrio.

---

## 7. Checklist para ativar a linha Ateliê
